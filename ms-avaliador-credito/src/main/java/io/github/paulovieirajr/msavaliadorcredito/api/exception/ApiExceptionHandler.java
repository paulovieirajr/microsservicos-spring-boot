...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntityNotFound(ResourceNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleBusiness(ConstraintViolationException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleFeignException(FeignException ex, WebRequest request) {
        ...
        HttpStatus status = HttpStatus.NOT_FOUND;
        ProblemType problemType = ProblemType.RESOURCE_NOT_FOUND;
        String detail = "O recurso solicitado não foi encontrado ou não está disponível no momento.";

...
class ClientRequestTest {
    ...
    void shouldThrowClientExceptionWhenNameIsBlank() {
        assertThrows(ClientException.class, () -> new ClientRequest("", "56010962013", 30).toEntity());
    }
    ...
    void shouldThrowClientExceptionWhenCPFIsInvalid() {
        assertThrows(ClientException.class, () -> new ClientRequest("John Doe", "123", 30).toEntity());
    }
    ...
    void shouldThrowClientExceptionWhenAgeIsNotPositive() {
        assertThrows(ClientException.class, () -> new ClientRequest("John Doe", "56010962013", 0).toEntity());
    }
}